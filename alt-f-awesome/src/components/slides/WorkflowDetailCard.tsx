  ...
  return (
    <div className="space-y-3 border-t border-[var(--brand-border)] pt-3">
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="rounded-[var(--brand-radius)] bg-[var(--brand-bg)] p-3">
        ...
        <div className="rounded-[var(--brand-radius)] bg-[var(--brand-accent)]/25 p-3">
          <p className="text-[10px] font-semibold tracking-wide text-[var(--brand-muted)] uppercase">
            Time back
          </p>
      ...
      {wf.foundationFor && wf.foundationFor.length > 0 && (
        <div className="rounded-[var(--brand-radius)] border border-[var(--brand-primary)]/15 bg-[var(--brand-primary)]/5 p-3">
          <p className="text-[10px] font-semibold tracking-wide text-[var(--brand-muted)] uppercase">
            Unlocks
          </p>
...
export function WorkflowCompact({
  ...
  return (
    <div
      className={`rounded-[var(--brand-radius)] border bg-white p-4 transition-shadow sm:p-5 ${
        expanded
    ...
    >
      ...
      <button
        ...
        className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-[var(--brand-radius)] border border-[var(--brand-border)] bg-[var(--brand-bg)] px-3 py-2 text-xs font-semibold text-[var(--brand-primary)] transition hover:border-[var(--brand-primary)]/30 hover:bg-[var(--brand-primary)]/5"
      >
...
export function WorkflowDetailCard({ wf }: { wf: Workflow }) {
  return (
    <div className="rounded-[var(--brand-radius)] border border-[var(--brand-border)] bg-white p-4 sm:p-5">
