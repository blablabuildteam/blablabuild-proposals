  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[280px_1fr] lg:gap-8">
      ...
      <div>
        ...
        <div className="rounded-[var(--brand-radius)] bg-[var(--brand-primary)] p-5 text-white sm:p-6">
        ...
        <div className="mt-4 rounded-[var(--brand-radius)] border border-[var(--brand-border)] bg-white p-5">
