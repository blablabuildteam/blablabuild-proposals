...
function RiceBreakdown({ wf }: { wf: { reach: number; impact: number; confidencePct: number; effort: number; riceReported: number } }) {
  ...
  return (
    <div className="mt-2 rounded-[var(--brand-radius)] bg-[var(--brand-bg)] px-3 py-2.5">
  ...
  return (
    <div>
      ...
      {startWorkflows.length > 0 && (
        <div className="mb-5 overflow-hidden rounded-[var(--brand-radius)] border-2 border-[var(--brand-accent)] bg-[var(--brand-accent)]/15">
