...
export function SlidePhaseNext() {
  ...
  return (
    <div>
      <div className="mb-6 rounded-[var(--brand-radius)] bg-[var(--brand-primary)] px-5 py-6 text-white sm:px-8 sm:py-8">
      ...
      {wf9 && (
        <div className="mt-5 rounded-[var(--brand-radius)] border border-dashed border-[var(--brand-primary)]/30 bg-white p-4">
