...
export function StatCard({
  ...
  return (
    <div className={`rounded-[var(--brand-radius)] border p-4 sm:p-5 ${bg}`}>
      <p
...
export function Callout({
  ...
  return (
    <div className={`rounded-[var(--brand-radius)] border-2 p-4 sm:p-5 ${styles}`}>
      {title && (
    ...
    <div className="grid gap-3 sm:grid-cols-3 sm:gap-4">
      {phases.map((phase, i) => {
        ...
        return (
          <div
            key={phase.label}
            className="flex flex-col overflow-hidden rounded-[var(--brand-radius)] border border-[var(--brand-border)] bg-white"
          >
